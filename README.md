...
Daedal Games 산하의 공개 협업 프로젝트입니다. 이 저장소가 제품 설계·개발·검증·릴리스의 정본이며, 현재 제품 계약은 이 README, 변경 제안과 로드맵 운영은 [기여 계약](CONTRIBUTING.md)이 소유합니다. 기여와 검증에 비공개 회사 문서 접근은 필요하지 않습니다.
